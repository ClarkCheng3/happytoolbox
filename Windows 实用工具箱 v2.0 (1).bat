...
if errorlevel 8 goto shutdown_menu
...
echo   [1] 显示设置           [2] 声音设置
echo   [3] 电源设置           [4] 网络设置
echo   [5] 时间和日期         [6] 用户账户设置
echo   [7] 返回主菜单
echo.
echo =================================================
echo.

choice /C 1234567 /N /M "请选择设置类别 [1-7]: "
...
powercfg /list
echo.
set /p plan_guid="请输入要使用的电源计划GUID: "
echo.
...
echo.
echo   [1] 立即关机           [2] 立即重启
echo   [3] 定时关机           [4] 取消关机计划
echo   [5] 锁定计算机         [6] 返回主菜单
echo.
echo =================================================
echo.
...
if errorlevel 6 goto main_menu
if errorlevel 5 goto lock_computer
if errorlevel 4 goto cancel_shutdown
if errorlevel 3 goto timed_shutdown
if errorlevel 2 goto restart_now
if errorlevel 1 goto shutdown_now
...
echo =================================================
echo.
choice /C YN /N /M "确定要立即关机吗? [Y/N]: "
if errorlevel 2 goto shutdown_menu
if errorlevel 1 (
    echo.
    echo 系统将在10秒后关机...
    timeout /t 10
...
echo   [1] 计算器             [2] 记事本
echo   [3] 截图工具           [4] 便签
echo   [5] 命令提示符         [6] PowerShell
echo   [7] 资源管理器         [8] 返回主菜单
echo.
echo =================================================
echo.

choice /C 12345678 /N /M "请选择工具 [1-8]: "

if errorlevel 8 goto main_menu
if errorlevel 7 goto explorer
if errorlevel 6 goto powershell
if errorlevel 5 goto cmd_prompt
if errorlevel 4 goto sticky_notes
if errorlevel 3 goto screenshot
